...
(function() {
    ...
    app.initSW = function(newScriptURL) {
    ...
    checkForUpdate(location.origin+'/pwa/update-sw2/service-worker.js?d='+ (new Date().getTime()), "./", function () {
